...
> **Source of truth สำหรับสถานะจริง** — อัพเดต 2026-08-28 (ChairOps แม่บ้าน: แก้ข้อมูล Centralอยุธยา กลับมาโชว์ในหน้าตรวจยอด/dashboard แล้ว — CEO อนุมัติ 2026-08-28 · ⚠️ CashHub Tea: พบเงิน ฿31,268/74 วัน หายไปเงียบๆ เพราะช่องทางชำระ "ไทยช่วยไทยพลัส" ไม่มีถังรองรับ + K Plus ปนกับ QR ผิดบัญชี — แก้แล้ว DEPLOYED · ChairOps แม่บ้าน: รวมกลไก "ปิดสาขา" ที่ซ้อนกัน 2 อันเป็นอันเดียว — DEPLOYED · LedgerLine: ปุ่ม "เงื่อนไขการแมตช์" ในหน้าบัญชีธนาคาร — DEPLOYED)
