...
> **Source of truth สำหรับสถานะจริง** — อัพเดต 2026-08-23 (CashHub Tea QR itemized: จับคู่อัตโนมัติไม่ติดเลยสักรายการ — เจอสาเหตุ+แก้ด้วยสมุดจำคีย์ ไม่ใช่บั๊กโค้ด · ChairOps แม่บ้าน: เอาคอลัมน์เดิมกลับมาครบ + โชว์คนล่าสุดต่อสาขา — DEPLOYED)
