...
**CEO อนุมัติ 2026-09-09** ("แก้ได้เลยอนุมัติดำเนินการเลย เช็คให้มั่นใจไปด้วยยันทั้งโปรแกรม") — กำลัง push + backfill ใบ Dohome + ไล่เช็คใบอื่นที่อาจโดนบั๊กเดียวกัน (ดูหัวข้อถัดไปเมื่อเช็คเสร็จ)
