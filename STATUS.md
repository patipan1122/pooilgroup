...
> **Source of truth สำหรับสถานะจริง** — อัพเดต 2026-08-28 (CashHub Tea: K Plus/ไทยช่วยไทยพลัส ส่งเข้า reconcile เป็นยอดรวม/วันเหมือนเดิม ไม่ itemize เหมือน QR — DEPLOYED · แยกบิล "Online Order" ออกเป็นช่องทางของตัวเอง — DEPLOYED · ChairOps แม่บ้าน: แก้ข้อมูล Centralอยุธยา กลับมาโชว์แล้ว — CEO อนุมัติ)
