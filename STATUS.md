...
> **Source of truth สำหรับสถานะจริง** — อัพเดต 2026-08-23 (⚠️ ChairOps แม่บ้าน: เจอ+แก้กลไก "ปิดสาขา" ซ้อนกัน 2 อัน + สาขาหายจากตรวจยอดโดยไม่ตั้งใจ — โค้ดพร้อม รอ CEO อนุมัติ deploy+แก้ข้อมูล · LedgerLine: ปุ่ม "เงื่อนไขการแมตช์" ในหน้าบัญชีธนาคาร — DEPLOYED)
