    ...
    return (
      <div className="mt-4 rounded-2xl border-2 border-dashed border-[var(--color-brand-200)] bg-gradient-to-br from-[var(--color-brand-50)]/40 to-white p-4">
        ...
        <p className="text-xs text-zinc-500 mt-2">
          {hasResumeFile
            ? "“ประเมินจากคำตอบ” = ใช้คำตอบในฟอร์ม (ไม่เห็นรูป/อายุ/เพศ) · “อ่านเรซูเม่” = AI เปิดไฟล์อ่านจริง (เห็นทั้งไฟล์ · สั่งไม่ให้ตัดสินจากรูป/อายุ/เพศ) — เป็นข้อมูลประกอบเท่านั้น"
