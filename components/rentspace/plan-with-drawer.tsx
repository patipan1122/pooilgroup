...
export function PlanWithDrawer({ units, view3dEnabled, canEdit }: { units: SlotUnit[]; view3dEnabled: boolean; canEdit?: boolean }) {
  const [selected, setSelected] = useState<string | null>(null);
  return (
    <>
      <SiteMap3D units={units} view3dEnabled={view3dEnabled} onSelect={setSelected} canEdit={canEdit} />
