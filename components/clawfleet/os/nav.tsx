...
export const BACK_NAV: ClawNavItem[] = [
  ...
  { key: "fleet711", label: "รายงานตู้ 7-11", href: `${OS_BASE}/711`, icon: Grid3x3, roles: [...MGR, "viewer"] },
...
export const SCREEN_META: Record<string, { title: string; sub: string }> = {
  ...
  fleet711: { title: "รายงานตู้ 7-11", sub: "ตู้ที่ตั้งในร้าน 7-11 · รายตู้ + สรุปรายวัน/รายเดือน + เทียบทุกตู้" },
