// CashHub Amazon — unit tests for granular POS-column sending (computeSendRows split
// decision, sanitizeRefLabel, legacyRefsForDay). Pure (no DB).
//
...
describe("CashHub Amazon granular POS-column send (money-safe: no split when it doesn't tie out)", () => {
