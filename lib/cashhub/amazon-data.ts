...
// key "qr" = c2+c14 (โอนรวมก้อนเดียว, fallback) · key "qrapi"/"qrstd" (2026-08-15, กฎ CEO แยก
//   2 กลุ่มย่อยตาม API/ไม่ API) = กลุ่มย่อยของ "qr" เดียวกัน ครอบ cvar ชุดเดียวกันทั้งคู่ (c2+c14 —
//   แยกย่อยตาม raw label ไม่ใช่แยกตาม cvar) → ทาสี "แมตช์แล้ว" ทั้ง 2 คอลัมน์เมื่อกลุ่มย่อยนั้นแมตช์
//   (ประมาณการเดิม: ถ้าอีกกลุ่มย่อยยังไม่แมตช์ คอลัมน์จะโชว์ "แมตช์แล้ว" ทั้งที่มีเงินอีกก้อนยังรอ —
//   known approximation เดียวกับตอนใช้ key "qr" รวมก้อนเดียว ไม่ใช่บั๊กใหม่) · c13 (QR Manual)
//   ตัดออกจากกลุ่ม "qr" แล้ว 2026-08-19 (CEO ยืนยัน: settle เป็นบรรทัดเดี่ยวของตัวเอง) → key "c13" =
//   cvar เดี่ยว เหมือน c12/c20/c21/c22 · key "qrcredit" (2026-08-15, POS_EXTRACT_GROUPS) = ครอบ
//   c2+c15 (คนละกลุ่มเดิมกันเลย — ดึง raw label ออกมาจาก 2 cvar คนละที่ ไม่ใช่ subset ของกลุ่มเดียว)
