...
export type AuditAction =
  ...
  | "IMPORT_AMAZON_SALES"
  | "UPSERT_AMAZON_BRANCH"
  | "DELETE_AMAZON_BRANCH"
  | "UPDATE_AMAZON_SETTLEMENT_CONFIG"
  | "UPDATE_HOTEL_SETTLEMENT_CONFIG"
  | "SEND_AMAZON_RECONCILE"
  | "SEND_HOTEL_RECONCILE"
  // ร้านชาไข่มุก (OWL CHA / MR.WOOF / SNOW DIP, POS Foodstory) — ดึง IV จาก TRCloud + เทียบ POS
  | "PULL_TEA_IV"
  | "IMPORT_TEA_POS"
  | "SAVE_TEA_CHANNEL_CONFIG"
  | "SAVE_LEDGER_MATCH_RULE"
  ...
  | "RENTSPACE_BILL_UPDATED"
  | "RENTSPACE_TAX_INVOICE_ISSUED"
  ...
  | "REPAIR_PHOTO_ADDED"
  | "REPAIR_LABOR_COST_SET"
  | "REPAIR_COMMENT_ADDED"
  | "REPAIR_ETA_SET"
  ...
  | "LEDGER_EXPENSE_PUSH_STARTED"
  | "LEDGER_EXPENSE_PUSHED_TRCLOUD"
  | "LEDGER_EXPENSE_PUSH_FAILED"
  | "LEDGER_EXPENSE_STOCKIN_PUSHED"
  | "LEDGER_EXPENSE_STOCKIN_FAILED"
  | "LEDGER_EXPENSE_TRCLOUD_AP_DELETE_STARTED"
  | "LEDGER_EXPENSE_TRCLOUD_AP_DELETE_FAILED"
  | "LEDGER_EXPENSE_TRCLOUD_AP_DELETED"
  // แก้ใบที่ส่งแล้ว → อัพเดต TRCloud (ap/update · po/update) — CEO 2026-07-26.
  | "LEDGER_EXPENSE_TRCLOUD_UPDATE_STARTED"
  | "LEDGER_EXPENSE_TRCLOUD_UPDATED"
  | "LEDGER_EXPENSE_TRCLOUD_UPDATE_FAILED"
