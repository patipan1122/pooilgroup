...
/**
 * แม่แบบสัญญา "เวอร์ชันเดิม (v1)" — พอร์ตจากข้อสัญญาเดิม (fallback ในคอมโพเนนต์) เป็นแม่แบบเลือกได้
 * เพื่อ "เก็บของเดิมไว้" ให้เลือกใช้กับสัญญาใหม่ได้ (CEO 2026-07-21). ใช้ CSS .rslease ชุดเดียวกับ v2.
 */
export const OLD_LEASE_BODY_V1 = `<style>
.rslease{line-height:1.75;color:#111}
.rslease .clause{margin:0 0 12px}
.rslease .clause h3{font-size:14.5px;font-weight:800;margin:0 0 5px;color:#111}
.rslease .clause p{margin:0 0 7px;text-align:justify}
.rslease .f{font-weight:600}
@media print{.rslease .clause{break-inside:avoid}.rslease .clause h3{break-after:avoid}}
</style>
<div class="rslease">
<section class="clause"><h3>ข้อ 1. พื้นที่และวัตถุประสงค์การเช่า</h3><p>ผู้ให้เช่าตกลงให้เช่าพื้นที่ห้อง <span class="f">{{unitCode}}</span> ภายในโครงการ {{projectName}} เพื่อใช้ประกอบกิจการของผู้เช่าตามที่ได้แจ้งไว้ ผู้เช่าจะไม่ดัดแปลงต่อเติมโครงสร้างหรือนำพื้นที่ไปให้ผู้อื่นเช่าช่วง โดยไม่ได้รับความยินยอมเป็นลายลักษณ์อักษรจากผู้ให้เช่าก่อน</p></section>
<section class="clause"><h3>ข้อ 2. ระยะเวลาการเช่า</h3><p>สัญญานี้มีกำหนดตั้งแต่ <span class="f">{{startDate}}</span> ถึง <span class="f">{{endDate}}</span> เมื่อครบกำหนดคู่สัญญาอาจตกลงต่ออายุสัญญาเป็นลายลักษณ์อักษร</p></section>
<section class="clause"><h3>ข้อ 3. ค่าเช่าและการชำระเงิน</h3><p>ผู้เช่าตกลงชำระค่าเช่าเดือนละ <span class="f">{{rentAmount}}</span> บาท ภายในวันที่ <span class="f">{{rentDueDay}}</span> ของทุกเดือน หากชำระล่าช้าผู้เช่ายินยอมให้คิด{{lateFee}}</p></section>
<section class="clause"><h3>ข้อ 4. เงินประกัน</h3><p>ผู้เช่าวางเงินประกันจำนวน <span class="f">{{depositAmount}}</span> บาท ซึ่งผู้ให้เช่าจะคืนให้เมื่อสิ้นสุดสัญญาและส่งมอบพื้นที่คืนในสภาพเรียบร้อย หลังหักค่าเสียหายและค่าใช้จ่ายค้างชำระ (ถ้ามี)</p></section>
<section class="clause"><h3>ข้อ 5. ค่าน้ำ–ค่าไฟและสาธารณูปโภค</h3><p>ผู้เช่าเป็นผู้รับผิดชอบค่าน้ำและค่าไฟฟ้าตามที่ใช้จริง โดยคิดอัตราค่าไฟหน่วยละ <span class="f">{{electricRate}}</span> บาท และค่าน้ำหน่วยละ <span class="f">{{waterRate}}</span> บาท ตามที่จดมิเตอร์ในแต่ละงวด รวมถึงค่าสาธารณูปโภคอื่นตามที่ใช้จริง</p></section>
<section class="clause"><h3>ข้อ 6. หน้าที่และการดูแลพื้นที่</h3><p>ผู้เช่าต้องดูแลรักษาพื้นที่เช่าให้อยู่ในสภาพดี ใช้พื้นที่ด้วยความระมัดระวัง รับผิดชอบความเสียหายที่เกิดจากการใช้งานของตนหรือบริวาร และปฏิบัติตามระเบียบและประกาศของโครงการโดยเคร่งครัด</p></section>
<section class="clause"><h3>ข้อ 7. การผิดนัดและการบอกเลิกสัญญา</h3><p>หากผู้เช่าผิดนัดชำระค่าเช่าหรือผิดเงื่อนไขสำคัญข้อใดข้อหนึ่ง และไม่แก้ไขภายในกำหนดเวลาที่ผู้ให้เช่าแจ้งเป็นหนังสือ ผู้ให้เช่ามีสิทธิบอกเลิกสัญญาได้ทันที และผู้เช่าต้องขนย้ายทรัพย์สินและส่งมอบพื้นที่คืนในสภาพเรียบร้อย</p></section>
<section class="clause"><h3>ข้อ 8. การบอกเลิกก่อนกำหนดและการคืนเงินประกัน</h3><p>หากฝ่ายใดประสงค์บอกเลิกสัญญาก่อนครบกำหนด ต้องแจ้งอีกฝ่ายเป็นหนังสือล่วงหน้าไม่น้อยกว่า 30 วัน ผู้ให้เช่าจะคืนเงินประกันให้ภายใน 30 วันนับจากวันที่ผู้เช่าส่งมอบพื้นที่คืนในสภาพเรียบร้อย หลังหักค่าเสียหายและค่าใช้จ่ายค้างชำระ (ถ้ามี) ทั้งนี้หากผู้เช่าย้ายออกก่อนกำหนดโดยไม่แจ้งล่วงหน้าตามที่กำหนด ผู้ให้เช่ามีสิทธิริบเงินประกันได้</p></section>
<section class="clause"><h3>ข้อ 9. ภาษีและค่าส่วนกลาง</h3><p>${LAND_TAX_CLAUSE}</p></section>
<section class="clause"><h3>ข้อ 10. กฎหมายที่ใช้บังคับ</h3><p>สัญญานี้อยู่ภายใต้บังคับและการตีความตามกฎหมายแห่งราชอาณาจักรไทย หากมีข้อพิพาทเกิดขึ้นคู่สัญญาตกลงให้อยู่ในเขตอำนาจของศาลไทย</p></section>
<section class="clause"><h3>ข้อ 11. ข้อตกลงเบ็ดเตล็ด</h3><p>สัญญานี้ทำขึ้นเป็นสองฉบับมีข้อความถูกต้องตรงกัน คู่สัญญาได้อ่านและเข้าใจข้อความโดยตลอดแล้วจึงลงลายมือชื่อไว้เป็นสำคัญ การแก้ไขเปลี่ยนแปลงใด ๆ ต้องทำเป็นลายลักษณ์อักษรและลงนามโดยคู่สัญญาทั้งสองฝ่าย</p></section>
</div>`;
