...
function iqImg(
  ...
  return {
    ...
    // A–F ให้ตรงตัวเลือก 6 ช่อง (2×3) ที่วาดในรูป · คำตอบถูกยังเป็น a–d เดิม (E,F = ตัวลวง)
    options: [
      { value: "a", label: "A" },
      { value: "b", label: "B" },
      { value: "c", label: "C" },
...
const iqMedium: FormSection = {
  ...
  fields: [
    iqImg("medium", 2, "c", "รูปไหนควรอยู่ตรงเครื่องหมาย ?"),
    iqImg("medium", 5, "c", "รูปไหนควรอยู่ตรงเครื่องหมาย ?"),
    iqImg("medium", 6, "b", "รูปที่ 5 ควรเป็นแบบใด ?"),
    iqImg("medium", 7, "c", "รูปไหนควรอยู่ตรงเครื่องหมาย ?"),
    iqImg("medium", 8, "d", "รูปไหนควรอยู่ตรงเครื่องหมาย ?"),
    iqImg("medium", 9, "b", "ช่องไหนควรอยู่ตรงเครื่องหมาย ?"),
  ],
};
...
const iqHard: FormSection = {
  ...
  fields: [
    ...
    iqImg("hard", 6, "b", "รูปไหนควรอยู่ตรงเครื่องหมาย ?"),
    iqImg("hard", 7, "a", "รูปถัดไป (ลำดับที่ 5) ควรเป็นรูปไหน ?"),
  ],
};
