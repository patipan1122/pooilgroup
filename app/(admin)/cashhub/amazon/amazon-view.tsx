      ...
      const typed = window.prompt(
        hasIv
          ? `⚠️ ฝืนส่งซ้ำเข้า TRCloud — วันที่ ${day.sales_date} (ยอด ${formatBaht(day.gross)})\n\n` +
            ...
            `(ยืนยันนี้ข้ามด่าน "ใบซ้ำ" เท่านั้น — ถ้ายอดแยกช่องทางยังไม่ครบ ระบบจะบล็อกอยู่ดี ต้องแก้ที่ต้นทาง)\n\n` +
          ...
          : `⚠️ ฝืนส่งเข้า TRCloud — วันที่ ${day.sales_date} (ยอด ${formatBaht(day.gross)})\n\n` +
            ...
            `(ยืนยันนี้ข้ามด่าน dedup เท่านั้น — ถ้ายอดแยกช่องทางยังไม่ครบ ระบบจะบล็อกอยู่ดี ต้องแก้ที่ต้นทาง)\n\n` +
