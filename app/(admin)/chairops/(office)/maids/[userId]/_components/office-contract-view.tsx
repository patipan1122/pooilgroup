...
// the signed (or draft) document with a real PDF download. ADMIN-gated by
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        {/* Plain <a download> — NOT window.print(), which stamps the browser's
            own URL/timestamp header into the output (CEO report 2026-09-23:
            looked unprofessional next to the real paper template). */}
        <a
          href={`/api/chairops/maids/${userId}/contract/pdf`}
          download
